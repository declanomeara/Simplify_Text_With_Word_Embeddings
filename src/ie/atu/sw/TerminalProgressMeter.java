...
public class TerminalProgressMeter {

	// Holder to decide if can be used, was in the runner class
	...
	/*
	 * public static void printProgress(int index, int total) { if (index > total)
	 * return; //Out of range int size = 50; //Must be less than console width char
	 * done = '█'; //Change to whatever you like. char todo = '░'; //Change to
	 * whatever you like.
	 * 
	 * //Compute basic metrics for the meter int complete = (100 * index) / total;
	 ...
	 * size; i++) { sb.append((i < completeLen) ? done : todo); }
	 * 
	 * 
	 ...
	 * 
	 * //Once the meter reaches its max, move to a new line. if (done == total)
	 * System.out.println("\n"); }
	 */
